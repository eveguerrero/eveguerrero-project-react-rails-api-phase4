    ...
    return (
        <div>
            ...
            <Grid container spacing={2}>
                <Grid item xs={2} md={2}>
                    <FilterBar onCategoryChange={onCategoryChange} selectedCategory={selectedCategory} onGenderChange={onGenderChange} selectedGender={selectedGender} setSelectedCauses={setSelectedCauses} causes={causes}/>
                </Grid>
